...
<head>
    ...
    <title>Work Experience | Job ShowRoom </title>
                                    ...
                                    <nav class="navbar navbar-default" role="navigation">
                                        ...
                                        <div class="side-menu-container">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li><a href="my-profile.blade.php"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a></li>
                                                    ...
                                                    <div id="dropdown-1" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <ul class="nav navbar-nav">
                                                                ...
                                                                <li class="active"><a href="workexperience.blade.php">Work Experience</a></li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            ...
                                            <span class="pull-left"><strong>Work Experience</strong></span>

                                            <span class="btn-small btn-cont pull-right">Edit Experience</span>
                                        </div>
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    ...
                                                    @foreach($jobs as $experience)
                                                    <div class="education-details">
                                                        <p class="pull-left"><strong>{{$experience->jwork_title}}</strong><small>({{$experience->jwork_level}})</small>
                                                            <br> {{$experience->jwork_organization}} ({{$experience->jwork_organizationtype}})
                                                            <br> {{$experience->jwork_datefrom}} - {{$experience->jwork_dateto}}
                                                            <br> {{$experience->jwork_location}}
                                                            <br> {{$experience->jwork_details}}:
                                                            <br>

                                                            <span>You are suggested to fill your actual duties and responsibilities, along with your major achievements to highlight yourself among the recruiters</span>

                                                        </p>
                                                        <div class="delete-icon pull-right">
                                                            <a href="{{route('workexperience.edit',$experience->jwork_id)}}"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>

                                                        </div>
                                                        {{--<form method="post" action="{{route('workexperience.destroy',$experience->jwork_id)}}">--}}
                                                            {{--<input type="hidden" value="_method" >--}}
                                                        {{--<div class="delete-icon pull-right">--}}
                                                            {{--<a href="{{route('workexperience.edit',$experience->jwork_id)}}"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i>Delete</a>--}}
