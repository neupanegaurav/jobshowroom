...
<head>
    <meta charset="utf-8">
     <title>Education | Job ShowRoom </title>
                                                    ...
                                                    <div id="dropdown-1" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <ul class="nav navbar-nav">
                                                                ...
                                                                <li class="active"><a href="education.blade.php">Education</a></li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            ...
                                            <span class="pull-left"><strong>Education</strong></span>

                                            @if($jobs == null)
                                                <a href="educationinfo/create"> <span class="btn-small btn-cont pull-right">Edit Education</span></a>


                                            @else
                                                <a href="educationinfo/create"> <span class="btn-small btn-cont pull-right">Add Another Education</span></a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    @if($jobs == null)
                                                        ...
                                                        <P>No education details published yet</P>


                                                    @else
                                                        @foreach($jobs as $jobeducation)
                                                            <div class="education-details">



                                                                <a href="{{route('educationinfo.edit',$jobeducation->jeducation_id)}}"> <span class="btn-small btn-cont pull-right">Edit Education</span></a>
                                                                <p><strong>{{$jobeducation->jeducation_institute}}</strong>,{{$jobeducation->jeducation_program}}  <span></span>
                                                                    <br> {{$jobeducation->program}},{{$jobeducation->jeducation_graduationdate}} </p>
                                                               {{$jobeducation->jeducation_board}},
                                                                <hr>
                                                    ...
                                                    {{--<div class="education-details">--}}
                                                        {{--<p><strong>I.sc.</strong>, 70 <span>% </span>--}}
                                                            {{--<br> Bihar Intermediate Council, 2010--}}
                                                            {{--<br> Adarsh College Madhepura(Bihar) </p>--}}
