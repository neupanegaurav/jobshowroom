                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    ...
                                                    <form method="POST" action="/educationinfo" class="form-horizontal edit-form">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4  text-right">
                                                                <label for="paasedyear" class="control-label">Passed Year <font color="#FF0000">*</font>:</label>

                                                            </div>
                                                             <div class="col-sm-8 ">
                                                                <input required="" name="passedyear" placeholder="Passed Year" type="text" class="form-control" id="passedyear" size="30" value="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4 text-right">
                                                                <label for="degree" class="control-label">Degree <font color="#FF0000">*</font>:</label>
                                                            </div> 
                                                             <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4 text-right">
                                                                <label for="institute" class="control-label">institute <font color="#FF0000">*</font>:</label>
                                                            </div> 
                                                             <div class="col-sm-8">
                                                                 <input required="" name="institute" placeholder="Institute" type="text" class="form-control" id="institute" size="30" value="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4 text-right">
                                                                <label for="gender" class="control-label">program <font color="#FF0000">*</font>:</label>
                                                            </div> 
                                                             <div class="col-sm-8">
                                                                <input required="" name="program" placeholder="Program" type="text" class="form-control" id="program" size="30" value="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4  text-right">
                                                                <label for="board" class="control-label">board <font color="#FF0000">*</font>:</label>

                                                            </div>
                                                             <div class="col-sm-8 ">
                                                                <input required="" name="board" placeholder="board" type="text" class="form-control" id="board" size="30" value="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-4  text-right">
                                                                <label for="score" class="control-label">Score <font color="#FF0000">*</font>:</label>

                                                            </div>
                                                             <div class="col-sm-8 ">
                                                                <input required="" name="score" placeholder="Score" type="text" class="form-control" id="score" size="30" value="">
