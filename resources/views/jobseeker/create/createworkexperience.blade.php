                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <form method="POST" action="/workexperience" class="form-horizontal edit-form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <input required="" name="organization" placeholder="Organization" type="text" class="form-control" id="Organization" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input required="" name="location" placeholder="location" type="text" class="form-control" id="location" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input required="" name="title" placeholder="title" type="text" class="form-control" id="program" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <input required="" name="level" placeholder="Level" type="text" class="form-control" id="board" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <input required="" name="category" placeholder="Category" type="text" class="form-control" id="category" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <input required="" name="datefrom" placeholder="Date From" type="date" class="form-control" id="datefrom" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <input required="" name="dateto" placeholder="Date To" type="date" class="form-control" id="dateto" size="30" value="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 ">
                                                            <textarea required="" name="description" placeholder="Job Description" type="date" class="form-control" id="description" size="30" value=""></textarea>
